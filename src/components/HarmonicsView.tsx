  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-4 flex flex-col h-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 my-2 text-xs">
        <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-100">
          ...
          <span className="text-base font-bold text-slate-800">
            {currentData.fundamentalV} V <span className="text-xs font-normal text-slate-500">rms/pk</span>
          </span>
        ...
        <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-100">
          ...
          <span className={`text-base font-bold ${compareMode === 'svpwm' ? 'text-emerald-700' : 'text-slate-700'}`}>
        ...
        <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-100">
          ...
          <span className={`text-base font-bold ${
            state.m > 1.0 ? 'text-amber-600' : 'text-emerald-600'
          }`}>
        ...
        <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-100">
          ...
          <span className="text-base font-bold text-sky-700">0.0% (Zero)</span>
          <span className="text-[10px] text-slate-500 block">
      ...
      <div className="relative flex-1 w-full my-2 min-h-[170px] flex flex-col justify-end">
        <div className="flex items-end justify-between gap-1 w-full h-[140px] px-2 pt-2 border-b border-slate-200">
          {currentData.harmonics.map((h, i) => {
            ...
            return (
              ...
              >
                ...
                {/* X Axis Order label */}
                <span className="text-[9px] text-slate-500 mt-1 font-mono font-medium">
